...
r = get_foxsi_optics_effarea(module_number = module_number, offaxis_angle = 0, /plot, orig_data = orig_data)
...
FOR i = 0, num_pixels-1 DO BEGIN
    FOR j = 0, num_pixels-1 DO BEGIN
        ...
        res = get_foxsi_optics_effarea(module_number = module_number, offaxis_angle = [pan, tilt])

FUNCTION get_blanket_atten, ENERGY_ARR = energy_arr, PLOT = plot, $
	MYLAR_UM = mylar_um, BE_UM = be_um, AL_UM = al_um, KAPTON_UM = kapton_um, $
	DATA_DIR = data_dir, NONSTD = nonstd, FACTOR = factor
...
; multiply all by 20.
mylar_um = factor*mylar_um
al_um = factor*al_um
kapton_um = factor*kapton_um

...
psf3 = rot_map( psf, 90 )
psf4 = rot_map( psf, 95 )
psf5 = rot_map( psf, 100 )

psf  = make_map( frebin( psf.data, dim, dim, /total ), dx=pix, dy=pix )
psf1 = make_map( frebin( psf1.data, dim, dim, /total ), dx=pix, dy=pix )
psf2 = make_map( frebin( psf2.data, dim, dim, /total ), dx=pix, dy=pix )
psf3 = make_map( frebin( psf3.data, dim, dim, /total ), dx=pix, dy=pix )
psf4 = make_map( frebin( psf4.data, dim, dim, /total ), dx=pix, dy=pix )
psf5 = make_map( frebin( psf5.data, dim, dim, /total ), dx=pix, dy=pix )

; renormalize:
psf.data = psf.data / total(psf.data)
psf1.data = psf1.data / total(psf1.data)
psf2.data = psf2.data / total(psf2.data)
psf3.data = psf3.data / total(psf3.data)
psf4.data = psf4.data / total(psf4.data)
psf5.data = psf5.data / total(psf5.data)
...
undefine, deconv & $
for i=0, iter[j] do max_likelihood, raw.data, psf1.data, deconv, reconv & $

...
psf  = rot_map( psf, rot )	; true should prob be ~79 deg.
...
img4=foxsi_image_solar(data_lvl2_d4,5,psize=pix,erange=erange,trange=tr,thr_n=4.,/xycor, size=[imdim,imdim])
...
; kluge!
map4 = rot_map(map4, 0, center=flare )
;
...
;popen, 'deconvolution-D0', xsi=8, ysi=11
!p.multi=[0,3,4]
...
!p.multi=0
plot_map, aia[0]
plot_map, shift_map(deconv_map[6], flare2[0], flare2[1]), /over, lev=[10,20,40,60,80], /per
